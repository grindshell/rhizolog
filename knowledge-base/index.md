# Rhizowiki Knowledge Base

This knowledge base tracks the design and implementation of Rhizowiki itself.
Every page should be reachable from this index.

## Pages

- [Product vision](product-vision.md) — what Rhizowiki is and who it's for
